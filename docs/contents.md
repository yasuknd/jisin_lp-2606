...
| 6 | Notice | 旧コース終了（補足） |
| 7 | Message | **女性自身の信頼感**（編集長コメント） |
| 8 | Entry | 最終申し込み |
| 9 | BottomCta | スクロール後も申し込み導線 |
...
| 編集長コメント | Message | `.message` | ブランド信頼 |
